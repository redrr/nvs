...
export default class AllSoloAnalytics extends React.Component<any, any> {
    ...
    render() {
        ...
        const Values = ({  x, y, bandwidth, data }) => (
            ...
            data.map((value, index) => (
                <Text
                    key={ index }
                    x={ value.value > CUT_OFF ? x(value.value) - 50 : x(value.value) + 50 }
        ...
        return (
            <View style={{paddingVertical: 16, paddingHorizontal: 8, width: '100%', backgroundColor: Colors.light.white, borderRadius: 12, marginVertical: 16}}>
                <ViewText style={styles.smallTitle} lightColor={Colors.light.darker} darkColor={Colors.dark.whiter}>
                    Egyéni választókerületi mandátumok
                </ViewText>
